...
/**
 * <p>Controls <code>String</code> formatting for {@link org.apache.commons.lang3.builder.ToStringBuilder}.
 * The main public interface is always via <code>ToStringBuilder</code>.</p>
 * <p/>
 * <p>These classes are intended to be used as <code>Singletons</code>.
 * There is no need to instantiate a new style each time. A program
 * will generally use one of the predefined constants on this class.
 * Alternatively, the {@link org.apache.commons.lang3.builder.StandardToStringStyle} class can be used
...
public abstract class ToStringStyle implements Serializable {
     ...
     * example from {@link org.apache.commons.lang3.builder.ToStringBuilder}, the output would look like this:
     * <p/>
     * <pre>
     ...
     * <code>Person</code> example from {@link org.apache.commons.lang3.builder.ToStringBuilder}, the output
     ...
     * from {@link org.apache.commons.lang3.builder.ToStringBuilder}, the output would look like this:
     * <p/>
     * <pre>
    ...
    /**
     * Create <code>ToStringStyle</code> instance from class name of the following
     * predefined styles:
     * <p/>
     * <ul>
     * <li>{@link #DEFAULT_STYLE}</li>
     * <li>{@link #SIMPLE_STYLE}</li>
     * <li>{@link #MULTI_LINE_STYLE}</li>
     * <li>{@link #SHORT_PREFIX_STYLE}</li>
     * <li>{@link #NO_FIELD_NAMES_STYLE}</li>
     * </ul>
     * <p/>
     * <p>If the String specified cannot match any of the above style's class
    ...
    public static ToStringStyle valueOf(String s) {
        ...
        if (S.isEqual(SIMPLE_STYLE.getClass().getName(), s)) return SIMPLE_STYLE;
        if (S.isEqual(MULTI_LINE_STYLE.getClass().getName(), s)) return MULTI_LINE_STYLE;
        if (S.isEqual(SHORT_PREFIX_STYLE.getClass().getName(), s)) return SHORT_PREFIX_STYLE;
        if (S.isEqual(NO_FIELD_NAMES_STYLE.getClass().getName(), s)) return NO_FIELD_NAMES_STYLE;
        throw new IllegalArgumentException("Unknown ToStringStyle: " + s);
    }
    ...
    public static ToStringStyle fromApacheStyle(org.apache.commons.lang3.builder.ToStringStyle apacheStyle) {
        ...
        if (apacheStyle == org.apache.commons.lang3.builder.ToStringStyle.MULTI_LINE_STYLE) return MULTI_LINE_STYLE;
        if (apacheStyle == org.apache.commons.lang3.builder.ToStringStyle.SHORT_PREFIX_STYLE) return SHORT_PREFIX_STYLE;
        if (apacheStyle == org.apache.commons.lang3.builder.ToStringStyle.NO_FIELD_NAMES_STYLE)
    ...
    public String toCode() {
        if (this == DEFAULT_STYLE) return "org.rythmengine.toString.ToStringStyle.DEFAULT_STYLE";
        if (this == SIMPLE_STYLE) return "org.rythmengine.toString.ToStringStyle.SIMPLE_STYLE";
        if (this == MULTI_LINE_STYLE) return "org.rythmengine.toString.ToStringStyle.MULTI_LINE_STYLE";
        if (this == SHORT_PREFIX_STYLE) return "org.rythmengine.toString.ToStringStyle.SHORT_PREFIX_STYLE";
        if (this == NO_FIELD_NAMES_STYLE) return "org.rythmengine.toString.ToStringStyle.NO_FIELD_NAMES_STYLE";
        return "org.rythmengine.toString.ToStringStyle.DEFAULT_STYLE";
    }
