...
public class Rythm extends DialectBase {
    ...
    protected Class<?>[] buildInParserClasses() {
        ...
        return new Class<?>[]{ArgsParser.class, BreakParser.class, ContinueParser.class, CacheParser.class, CommentParser.class, DebugParser.class,
                ...
                ImportParser.class, IncludeParser.class, InitCodeParser.class, RawParser.class, RenderBodyParser.class, RenderSectionParser.class,
