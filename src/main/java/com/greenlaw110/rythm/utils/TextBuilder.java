...
public class TextBuilder implements Cloneable {
    ...
    protected static final class StringWrapper {    
        private final String s_;
        private byte[] ba_;
        
        public StringWrapper(String s, byte[] ba) {
            if (null == s || "".equals(s)) {
                s_ = "";
                ba_ = new byte[]{};
            } else {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof StringWrapper) {
                return s_.equals(((StringWrapper)obj).s_);
            }
            return false;
        }
    }
    ...
    private void p_(StringWrapper wrapper) {
        if (null != _out) append(wrapper);
        else _caller.p(wrapper);
    }
    
    public final TextBuilder p(StringWrapper wrapper) {
