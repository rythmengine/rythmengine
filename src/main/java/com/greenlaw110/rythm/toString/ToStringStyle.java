...
public abstract class ToStringStyle implements Serializable {
    ...
    public String toCode() {
        ...
        if (this == MULTI_LINE_STYLE) return "com.greenlaw110.rythm.toString.ToStringStyle.MULTI_LINE_STYLE";
        if (this == SHORT_PREFIX_STYLE) return "com.greenlaw110.rythm.toString.ToStringStyle.SHORT_PREFIX_STYLE";
        if (this == NO_FIELD_NAMES_STYLE) return "com.greenlaw110.rythm.toString.ToStringStyle.NO_FIELD_NAMES_STYLE";
        return "com.greenlaw110.rythm.toString.ToStringStyle.DEFAULT_STYLE";
    }
